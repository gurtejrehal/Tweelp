"""
Django settings for tweelp project.
...
SECRET_KEY = '+xouu!3ceg4!f^zbk0#%j0-1ain48syt$ca9u+jsy&tdlb1)iv'
...
WSGI_APPLICATION = 'tweelp.wsgi.application'
